   ...
   [Area(SD.IDENTITY_AREA)]
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManger, IRepository<ApplicationUserOTP> applicationUserOTPRepository,
        ...
        public async Task<IActionResult> ValidateOTP(ValidateOTPVM validateOTPVM)
        {
            ...
            var otpInDB = (await _applicationUserOTPRepository.GetAsync(e => e.ApplicationUserId == userId.ToString() && !e.IsUsed))
                .OrderByDescending(e => e.CerateAt).FirstOrDefault();
        ...
        //Mothod For  Confirm Email And Reset Password
